...
def set_bg_hack_url():
    ...
    st.markdown(
         ...
         <style>
         .stApp {{
             background: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUQt6wJZD5iVg3SI_YpD1MdYaErM5hN-DIeg&usqp=CAU");
...
artist_data=pd.read_csv('Artist_dataset.csv')
